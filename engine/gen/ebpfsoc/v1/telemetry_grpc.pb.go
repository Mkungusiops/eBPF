...
const (
	TelemetryService_StreamTelemetry_FullMethodName = "/ebpfsoc.v1.TelemetryService/StreamTelemetry"
)
...
func (c *telemetryServiceClient) StreamTelemetry(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TelemetryBatch, TelemetryAck], error) {
...
type TelemetryService_StreamTelemetryClient = grpc.BidiStreamingClient[TelemetryBatch, TelemetryAck]
...
func (UnimplementedTelemetryServiceServer) StreamTelemetry(grpc.BidiStreamingServer[TelemetryBatch, TelemetryAck]) error {
...
func _TelemetryService_StreamTelemetry_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TelemetryServiceServer).StreamTelemetry(&grpc.GenericServerStream[TelemetryBatch, TelemetryAck]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TelemetryService_StreamTelemetryServer = grpc.BidiStreamingServer[TelemetryBatch, TelemetryAck]
...
var TelemetryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ebpfsoc.v1.TelemetryService",
	...
	Metadata: "ebpfsoc/v1/telemetry.proto",
}
