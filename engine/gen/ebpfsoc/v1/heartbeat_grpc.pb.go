...
const (
	HeartbeatService_Heartbeat_FullMethodName = "/ebpfsoc.v1.HeartbeatService/Heartbeat"
)
...
var HeartbeatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ebpfsoc.v1.HeartbeatService",
	...
	Metadata: "ebpfsoc/v1/heartbeat.proto",
}
